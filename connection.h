...
static bool createConnection()
{
   ...
   */
    ...
    query.exec("create table person (id int primary key, "
               "login varchar(20), password varchar(20), status boolean)");
    query.exec("insert into person values(101, 'Danny', 'qwerty', '0')");


    query.exec("create table experiments (id int primary key, date datetime, input_info text,"
               "output_info text, comment text, user_id int)");
    /*
